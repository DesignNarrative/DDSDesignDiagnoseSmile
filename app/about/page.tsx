...
import { Phone, Clock, Mail, CheckCircle2, Trophy, Award, Star } from "lucide-react";
...
export default function AboutPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      {/* ── 8.5. Awards & Recognitions Banner ── */}
      <section id="achievements" className="relative w-full aspect-[6836/3535] overflow-hidden flex items-center bg-[#380920]">
        <div className="absolute inset-0 z-0">
          <Image
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 md:px-12 w-full text-center">
          ...
          >
            <h2 className="font-caudex font-bold text-2xl sm:text-4xl md:text-5xl lg:text-6xl text-white leading-tight">
      ...
      {/* ── 8.7. Community Appreciation Awards Section ── */}
